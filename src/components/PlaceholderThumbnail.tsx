...
export default function PlaceholderThumbnail({ row, rowIndice, isDragging, isLoading, totalPages, margin }) {
    ...
    const [{ canDrop, isOver }, drop] = useDrop({
        accept: "pdfThumbnail",
        drop: () => {
            //console.log(`toRow: ${rowIndex}. toRowIndice: ${rowIndice}`)
            return { row, rowIndice: Math.ceil(rowIndice), type: 'placeholderThumbnail' }
        },
        collect: (monitor) => ({
